...
import 'package:uhuru/config/routes/auth_guard.dart' as _i11;
import 'package:uhuru/core/injection/register_module.dart' as _i13;
import 'package:uhuru/core/network/dio_client.dart' as _i4;
import 'package:uhuru/core/session/session_manager.dart' as _i9;
import 'package:uhuru/core/session/session_manager_impl.dart' as _i10;
...
import 'package:uhuru/features/auth/domain/repository/auth_repository.dart'
    as _i7;
import 'package:uhuru/features/auth/presentation/bloc/auth_bloc.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.SessionManager>(
        () => _i10.SessionManagerImpl(gh<_i5.FlutterSecureStorage>()));
    gh.factory<_i11.AuthGuard>(() => _i11.AuthGuard(gh<_i9.SessionManager>()));
    gh.factory<_i12.AuthBloc>(() => _i12.AuthBloc(
          gh<_i7.AuthRepository>(),
          gh<_i9.SessionManager>(),
        ));
    return this;
  }
}
